...
var CallBuilder = exports.CallBuilder = (function () {
  ...
  _createClass(CallBuilder, {
    ...
    _pageSwitch: {
      value: function _pageSwitch(links, direction) {
        var _this = this;
        ...
        return function (keypair) {
          ...
          if (keypair) {
            config = _this._getRequestConfig(URI(link), keypair);
          }

          return _this._sendNormalRequest(URI(link), config).then(function (r) {
