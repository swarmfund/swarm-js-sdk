...
var SalesCallBuilder = exports.SalesCallBuilder = (function (_CallBuilder) {
  ...
  _createClass(SalesCallBuilder, {
    ...
    reachedSoftCap: {
      ...
      value: (function (_reachedSoftCap) {
        var _reachedSoftCapWrapper = function reachedSoftCap() {
          return _reachedSoftCap.apply(this, arguments);
        };

        _reachedSoftCapWrapper.toString = function () {
          return _reachedSoftCap.toString();
        };

        return _reachedSoftCapWrapper;
      })(function () {
        var reachedSoftCap = arguments[0] === undefined ? true : arguments[0];
    ...
    nearlyFunded: {
      ...
      value: function nearlyFunded() {
        var bound = arguments[0] === undefined ? 90 : arguments[0];
    ...
    withGoalValue: {
      ...
      value: function withGoalValue() {
        var goalValue = arguments[0] === undefined ? 0 : arguments[0];
